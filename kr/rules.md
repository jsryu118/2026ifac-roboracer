...
- 본선에서 장애물과의 충돌은 계속 주행할 수 있다면 괜찮지만, 예선에서 장애물과의 충돌 및 사소한 접촉은 해당 랩을 무효화합니다.
...
- 경주 중에 사람의 의도가 들어간 파라미터 튜닝 또는 경로 계획 (예선-<span style="color:#e67e22; font-weight:bold;">한순위 강등</span>, 본선-<span style="color:#e74c3c; font-weight:bold;">1랩 페널티</span>)
- 경주 중에 키보드, 마우스를 사용한 경우 (예선-<span style="color:#e67e22; font-weight:bold;">한순위 강등</span>, 본선-<span style="color:#b8860b; font-weight:bold;">경고</span>)
...
- 3회 경고가 누적 된 경우 (본선-<span style="color:#e74c3c; font-weight:bold;">1랩 페널티</span>)
- 경주 중 상대방 차량에 대한 사람의 **치명적인 방해** (본선-<span style="color:#e74c3c; font-weight:bold;">1랩 페널티</span>)
  - 트랙을 고치러 가다가 상대방 차량에 물리적인 접촉으로 주행에 영향을 주는 경우
- **완전한 후방 충돌로 피해를 준 경우** (본선-<span style="color:#e74c3c; font-weight:bold;">1랩 페널티</span>)
- **완전한 후방 충돌이 아니더라도 큰 충격을 동반한 사고** (본선-<span style="color:#e74c3c; font-weight:bold;">1랩 페널티</span>)
- 충돌로 인해 망가진 트랙을 적극적으로 수정하지 않는 경우 (예선-<span style="color:#e67e22; font-weight:bold;">한순위 강등</span>, 본선-<span style="color:#b8860b; font-weight:bold;">경고</span>)
  - 매 바퀴마다 제대로 수정하지 않을 시 새로운 경고 부여 가능
- 부정출발 (본선-<span style="color:#b8860b; font-weight:bold;">경고</span>)
- 감지 박스의 고정이 제대로 되지 않는 경우 (본선-<span style="color:#b8860b; font-weight:bold;">경고</span>)
  - 매 바퀴마다 제대로 수정하지 않을 시 새로운 경고 부여 가능
- 경주 진행 중, 추가 1바퀴가 누적되어 총 3바퀴가 추가 되었을 경우. (본선-<span style="color:#8b0000; font-weight:bold;">실격</span>)
- 경주 중 자신의 차량에 대한 **개입** (본선-<span style="color:#b8860b; font-weight:bold;">경고</span>)
  - 충돌 이후 차량을 트랙 바깥으로 빼는 행위
  - 차량의 헤딩을 직접 수정하는 경우
- 경주 중 상대방 차량에 대한 사람의 **방해** (본선-<span style="color:#b8860b; font-weight:bold;">경고</span>)
