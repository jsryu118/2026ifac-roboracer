...
- 팀은 **킬 스위치(kill switch)** — 사람이 수동으로 차량을 즉시 정지시키는 비상 정지 장치 — 를 시연해야 합니다.
- 킬 스위치는 누르고 있는 방식이 아니라 **토글(on/off) 방식**으로 동작해야 합니다.
- 킬 스위치는 **안전상의 비상 상황에서만** 사용합니다. 사람이 충돌을 예측하고 미리 작동시켜 회피 수단으로 쓰는 것은 **금지**됩니다 (7.1 참조).
...
- 예선 3은 1분 동안 장애물이 없는 트랙에서 **최소 랩타임**을 달성하는 것을 목표로 합니다.
- 1분동안 자유롭게 진행 중 가장 짧은 랩타임을 기준으로 합니다.
...
- 정적 장애물에 접촉이 있는 경우 **진행 중인 랩을 무효화**하고 **완주 랩 수에서 제외**됩니다.
...
- 예선전의 최종 순위 결정은 다음 기준을 순서로 결정됩니다.
  ...
  - 통과한 예선의 수
  - 가장 마지막으로 완료한 예선의 기록
  - Q3의 유효한 laptime이 존재하지 않고, Q2 또는 Q1의 기록이 동점인 경우, inspection을 먼저 완료한 팀이 높은 순위를 가집니다.
...
- **Day 3 (8월 26일):** Group Stage — 각 그룹 내에서 경기가 진행되며, Day 4 진출자를 그룹 당 3팀씩 선발합니다.
- **Day 4 (8월 27일):** Day 3에서 선발된 팀이 32강 경기를 치릅니다.
- 참가팀의 수에 따라 경기 구성이 변경될 수 있습니다.

## 6.2 일반

- 두 차량은 반대 방향에 위치한 서로 다른 출발선에서 시작합니다.
- 총 3 개의 정적 장애물이 사용됩니다. 모든 팀이 경주 준비를 완료한 후 참가 팀이 각각 한 개의 장애물을 설치하며, 심판이 다른 하나의 장애물을 설치합니다.
- 트랙의 정적 장애물은 선두 차량이 완주해야 할 총 랩 수의 **절반**을 완주하였을 때 제거됩니다.
- 각 차량은 시간 제한 내에 장애물과 상대방을 피하면서 10랩을 먼저 완주해야 합니다.

## 6.3 목표

- 먼저 10바퀴를 완주하기.
  - 8강 이후의 경기는 경기 상황을 고려해 20바퀴로 수정이 될 수 있습니다.
...
- **정상 주행 중 킬 스위치 작동은 엄격히 금지됩니다** — 안전상의 비상 상황에서만 사용하며, 충돌 회피 목적으로는 사용할 수 없습니다 (3.3.1 참조).
...
<tr><td style="vertical-align: top;"><img src="../images/rules/examples/invalid2_장애물_터치.gif" style="width: 1440px; max-width: 100%;" /></td><td style="vertical-align: top;"><strong>Case 4</strong>: 장애물과의 접촉 및 충돌이 생긴 경우<br>접촉의 강도와 상관없이 경미한 접촉이더라도, 예선에서는 랩 카운트가 초기화됩니다. 본선에서는 페널티가 없습니다.</td></tr>
