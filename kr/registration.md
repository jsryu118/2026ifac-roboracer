...
<div style="font-size: 1.1rem; font-weight: bold; margin-bottom: 0.8rem;">학회 등록</div>
<p style="font-size: 0.85rem; margin-bottom: 1rem;">IFAC 2026에 등록합니다.<br>등록 비용은 <a href="#registration-fee">해당 표</a>를 참고해주세요.</p>
<a href="https://www.ifac2026.org/fairContents.do?FAIRMENU_IDX=21697&hl=ENG" class="button small">학회 등록</a>
</div>

<div style="flex: 1; min-width: 220px; max-width: 300px; border: 2px solid #444; border-radius: 12px; padding: 1.5rem; text-align: center; background: rgba(255,255,255,0.03);">
<div style="font-size: 2.5rem; font-weight: bold; color: #f56a6a; margin-bottom: 0.5rem;">2</div>
<div style="font-size: 1.1rem; font-weight: bold; margin-bottom: 0.8rem;">구글폼 제출</div>
<p style="font-size: 0.85rem; margin-bottom: 1rem;">팀 정보를 등록합니다.<br>제공하신 명단으로 대회를 준비합니다.</p>
<a href="https://forms.gle/RvSRwHdDqSfyQyvF6" class="button small">구글폼 제출</a>
</div>

<div style="flex: 1; min-width: 220px; max-width: 300px; border: 2px solid #444; border-radius: 12px; padding: 1.5rem; text-align: center; background: rgba(255,255,255,0.03);">
<div style="font-size: 2.5rem; font-weight: bold; color: #f56a6a; margin-bottom: 0.5rem;">3</div>
<div style="font-size: 1.1rem; font-weight: bold; margin-bottom: 0.8rem;">등록 확인</div>
<p style="font-size: 0.85rem; margin-bottom: 1rem;">홈페이지 참가 목록에서<br>팀 등록 여부를 확인하세요.</p>
<a href="#참가자" class="button small">참가 목록 확인</a>
</div>

</div>

<center style="font-size: 0.85rem;">1번, 2번을 완료하였음에도 참가 목록에 없는 팀은 <a href="mailto:ryujs@unist.ac.kr">ryujs@unist.ac.kr</a>로 문의하세요.</center>

<br>

- IFAC 등록과 Google Form 제출을 둘 다 해야합니다. Google Form은 IFAC 등록 전에 먼저 제출해도 됩니다.
- IFAC competition 등록은 인당 100유로가 필요합니다.
...
<center class="actions">
	<a href="https://join.slack.com/t/robo-racer/shared_invite/zt-2sfu4qr7p-3oe27mCnH98muwRR9uEAbg" class="button">Slack 통한 질문</a>
</center>
<br>
위 버튼을 눌러 ROBORACER 공식 SLACK에 참여하신 후 **2026ifac-competition** 채널을 추가해주세요.
...
suibmission google foam 


 < >
Registration Conference 

위는 돈 안들고 학회는 인당 100유로다 
